...
const tourSchema = new mongoose.Schema(
  //schema-object
  {
    name: {
      ...
      unique: true,
      trim: true,
      maxlength: [40, 'A name can have maximum 40 characters'],
      minlength: [10, 'A name can have minimum 10 characters'],
      // validate: [validator.isAlpha, 'A tour name contains only characters'],
    },
    slug: String,
    ...
    difficulty: {
      ...
      enum: {
        ...
        message: 'Difficulty available:easy,medium and difficult',
      },
    },
