        ...
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (result.data.status === 'success') {
              (0, _alerts.showAlert)('success', result.data.message);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            _context.prev = 7;
            _context.t0 = _context["catch"](0);
            (0, _alerts.showAlert)('error', 'Error occured while logging Out');
...
var displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Marker({
      element: elem,
      anchor: 'bottom'
    }).setLngLat(loc.coordinates).addTo(map); //app popuop

    new mapboxgl.Popup({
      className: 'mapboxgl-popup'
    }).setLngLat(loc.coordinates).setHTML("<p>".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); //extend map bound to include the current location
...
var updateSettings = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data, type) {
    var updatePassUrl, updateDataUrl, url, updatedData;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            updatePassUrl = 'http://127.0.0.1:3000/api/v1/users/update-password';
            updateDataUrl = 'http://127.0.0.1:3000/api/v1/users/update-profile';
            url = type === 'password' ? updatePassUrl : updateDataUrl;
            _context.next = 6;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
...
var userUpdatePassBtn = document.querySelector('.form-user-settings');
var signupForm = document.querySelector('.form-signup-data');
...
if (userUpdatePassBtn) {
  userUpdatePassBtn.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
      var password, newPassword, newPasswordConfirm, data;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
...
},{"regenerator-runtime/runtime":"../../node_modules/regenerator-runtime/runtime.js","./login":"login.js","./signup":"signup.js","./logout":"logout.js","./mapBox":"mapBox.js","./updateSettings":"updateSettings.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
